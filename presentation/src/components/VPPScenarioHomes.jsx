...
const SUMMER_STEPS = [
  ...
  },
  {
    ...
    showHomeDetail: true,
    homeDetail: {
      solar: { status: 'generating', flow: 'to-grid', kw: 4.2 },
      battery: { status: 'charging', level: 0.05, flow: 'from-grid', kw: 5.0 },
      ev: { status: 'charging', level: 0.15, flow: 'from-grid', kw: 7.4 },
      heatPump: { status: 'off', kw: 0 },
      gridPrice: '-5 ct/kWh',
    },
  },
  {
