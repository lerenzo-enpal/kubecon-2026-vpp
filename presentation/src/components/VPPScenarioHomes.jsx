...
const SUMMER_STEPS = [
  {
    narration: 'Sunny July afternoon in Berlin. Solar panels across thousands of homes produce peak energy.',
  ...
  {
    narration: 'Wholesale prices collapse toward zero. Flexa holds the batteries empty -- on purpose.',
    highlight: 'Energy Arbitrage',
    highlightColor: colors.success,
  ...
  {
    narration: 'Prices turn negative. Flexa commands: charge everything. We are PAID to consume electricity.',
    highlight: 'Energy Arbitrage',
    highlightColor: colors.success,
  ...
  {
    narration: 'Sun sets, prices spike. Flexa discharges full batteries into the grid at peak prices.',
  ...
  {
    narration: 'Price peaks softened. Revenue earned. Fossil generation reduced. Arbitrage + Peak Shaving.',
    highlight: 'Result',
...
const WINTER_STEPS = [
  {
    narration: 'Cold January morning. Weak winter sun. Heat pumps running across Berlin to keep homes warm.',
  ...
  {
    narration: '800 MW generator trips offline. Grid frequency drops below 49.8 Hz -- the danger threshold.',
  ...
  {
    narration: 'Within 200ms Flexa responds. EV charging pauses. Heat pumps pause 20 min. Batteries discharge.',
  ...
  {
    narration: '12,000+ homes respond as one. 15 MW freed in 200ms. Invisible to residents, critical for the grid.',
    highlight: 'Demand Response',
    highlightColor: colors.primary,
  ...
  {
    narration: 'Grid stabilized. Heat pumps resume. Frequency Regulation + Demand Response -- invisible, critical.',
