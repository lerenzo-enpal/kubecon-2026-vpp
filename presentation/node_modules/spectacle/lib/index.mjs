            ...
            AnimatedDiv,
            {
              ...
              children: /* @__PURE__ */ jsxs4(
                ...
                __spreadProps(__spreadValues({
                  ...
                  children: [
                    (slideHasTemplate && isActive || inOverviewMode || inPrintMode) && /* @__PURE__ */ jsx8(template_wrapper_default, { style: wrapperOverrideStyle, children: templateElement }),
                    /* @__PURE__ */ jsx8(
                      SlideWrapper2,
                      {
...
function PrintMode({
  ...
  return /* @__PURE__ */ jsxs5(Fragment2, { children: [
    /* @__PURE__ */ jsx9(PrintStyle, { pageSize: computedPageSize }),
    /* @__PURE__ */ jsx9(
      DeckInternal,
      {
        printMode: true,
...
function onRender({ item, active }) {
  if (typeof item === "string") {
    return /* @__PURE__ */ jsx10(ResultSectionHeader, { children: item });
  } else {
    return /* @__PURE__ */ jsxs6(ResultCommand, { active, children: [
      /* @__PURE__ */ jsx10(Text, { fontFamily: SYSTEM_FONT, children: item.name }),
      /* @__PURE__ */ jsx10(ResultShortcut, { children: getShortcutKeys(item).map(
        (key) => key && /* @__PURE__ */ jsx10(ResultShortcutKey, { children: key }, `${item.id}-${key}`)
      ) })
    ] });
  }
}
var CommandBarResults = () => {
  ...
  return /* @__PURE__ */ jsx10(KBarResults, { items: results, onRender });
};
...
var CommandBarSearch = () => {
  return /* @__PURE__ */ jsx11(KBarPortal, { children: /* @__PURE__ */ jsx11(KBarPositioner, { children: /* @__PURE__ */ jsxs7(KBarAnimatorStyled, { children: [
    /* @__PURE__ */ jsx11(KBarSearchStyled, {}),
    /* @__PURE__ */ jsx11(results_default, {})
  ] }) }) });
};
...
var View = (_a) => {
  ...
  switch (mode) {
    case SPECTACLE_MODES.DEFAULT_MODE:
      return /* @__PURE__ */ jsx13(default_deck_default, __spreadProps(__spreadValues({}, props), { toggleMode }));
    case SPECTACLE_MODES.PRESENTER_MODE:
      return /* @__PURE__ */ jsx13(presenter_mode_default, __spreadValues({}, props));
    case SPECTACLE_MODES.PRINT_MODE:
      return /* @__PURE__ */ jsx13(PrintMode, __spreadValues({}, props));
    case SPECTACLE_MODES.EXPORT_MODE:
      return /* @__PURE__ */ jsx13(PrintMode, __spreadProps(__spreadValues({}, props), { exportMode: true }));
    case SPECTACLE_MODES.OVERVIEW_MODE:
      return /* @__PURE__ */ jsx13(default_deck_default, __spreadValues({ overviewMode: true, toggleMode }, props));
    default:
...
var SpectacleDeck = (props) => {
  ...
  return /* @__PURE__ */ jsx13(command_bar_default, { children: /* @__PURE__ */ jsx13(
    View,
    __spreadValues({
      getCurrentMode,
      toggleMode
...
var Appear = (props) => {
  ...
  return /* @__PURE__ */ jsx14(SteppedComponent, __spreadProps(__spreadValues({}, restProps), { numSteps: 1, children }));
};
var Stepper = (props) => {
  const _a = props, {
    values,
...
var CodePane = forwardRef2(
  (_a, ref) => {
    ...
    const scrollTarget = useRef10(null);
    ...
    return /* @__PURE__ */ jsxs10(Fragment5, { children: [
      placeholder,
      /* @__PURE__ */ jsx15(Container, __spreadProps(__spreadValues({ ref }, props), { children: /* @__PURE__ */ jsx15(
        SyntaxHighlighter,
        {
          customStyle,
          language,
...
var Table = styled13.table.attrs((props) => __spreadValues({
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
  textAlign: "left",
  margin: "listMargin",
  width: 1
}, props))(compose4(color4, typography2, space4, border2, layout3));
var TableHeader = styled13.thead.attrs((props) => __spreadValues({
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
  fontWeight: "bold",
...
var TableBody = styled13.tbody.attrs((props) => __spreadValues({
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
  textAlign: "left",
...
var TableRow = styled13.tr.attrs((props) => __spreadValues({
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
  textAlign: "left",
...
var TableCell = styled13.td.attrs((props) => __spreadValues({
  color: "primary",
  fontFamily: "text",
  fontSize: "text",
  textAlign: "left",
...
var FullSizeImage = styled14(Image).attrs((props) => __spreadValues({
  maxWidth: "100%",
  maxHeight: "100%"
}, props));
...
var Notes = ({ children }) => {
  ...
  if (!notePortalNode)
    return null;
  return ReactDOM2.createPortal(/* @__PURE__ */ jsx16("div", { children }), notePortalNode);
};
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ jsx17(
      ...
      __spreadProps(__spreadValues({
        ...
        children: Array(slideCount).fill(0).map((_, idx) => /* @__PURE__ */ jsx17(
          Circle,
          {
            color: color5,
...
var AnimatedProgress = forwardRef4(
  (_a, ref) => {
    ...
    const [pacmanOffsetLeft, setPacmanOffsetLeft] = useState11(
      null
    );
    const [pacmanOffsetTop, setPacmanOffsetTop] = useState11(null);
    const [alternateAnimation, setAlternateAnimation] = useState11(false);
    const [activeCircleNode, setActiveCircleNode] = useState11(null);
    ...
    return /* @__PURE__ */ jsxs11(ProgressContainer, __spreadProps(__spreadValues({ ref, position: "relative" }, props), { children: [
      ...
      Array(slideCount).fill(0).map((_, idx) => /* @__PURE__ */ jsx18(
        Circle,
        {
...
import { forwardRef as forwardRef5, useEffect as useEffect15, useState as useState12 } from "react";
...
var FullScreen = forwardRef5(
  (_a, ref) => {
    var _b = _a, { size = 24, color: color5 = "#fff" } = _b, props = __objRest(_b, ["size", "color"]);
    ...
    return /* @__PURE__ */ jsx19(
      ...
      __spreadProps(__spreadValues({
        ...
        children: /* @__PURE__ */ jsx19("svg", { width: size, height: size, viewBox: "0 0 512 512", children: /* @__PURE__ */ jsx19(
          "path",
          {
            fill: color5,
...
var Full = (_a) => {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children }));
};
var Center = (_a) => {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsx20(FlexBox, { justifyContent: "center", alignItems: "center", height: "100%", children: /* @__PURE__ */ jsx20(Box, { children }) }) }));
};
var TwoColumn = (_a) => {
  var _b = _a, {
    left,
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsxs12(FlexBox, { flexDirection: "row", alignItems: "start", flex: 1, children: [
    /* @__PURE__ */ jsx20(Box, { width: "100%", children: left }),
    /* @__PURE__ */ jsx20(Box, { width: "100%", children: right })
  ] }) }));
};
var Ul = ({
  items = [],
  ...
  return /* @__PURE__ */ jsx20(List2, __spreadProps(__spreadValues({}, listProps), { children: items.map((item, i) => {
    const Wrapper = animate ? Appear : Fragment6;
    return /* @__PURE__ */ jsx20(Wrapper, { children: /* @__PURE__ */ jsx20(ListItem, { children: item }, i) }, i);
  }) }));
};
var List = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ jsxs12(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    title ? /* @__PURE__ */ jsx20(Heading, __spreadProps(__spreadValues({ textAlign: "left" }, titleProps), { children: title })) : null,
    /* @__PURE__ */ jsx20(
      Ul,
      {
        items,
...
var Header = (_a) => {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsx20(FlexBox, __spreadProps(__spreadValues({ height: "100%" }, flexBoxProps), { children: /* @__PURE__ */ jsx20(Heading, __spreadProps(__spreadValues({}, headingProps), { children })) })) }));
};
var Section = ({
  sectionProps,
  children
...
var Statement = ({
  statementProps,
  children
}) => /* @__PURE__ */ jsx20(Header, { headingProps: statementProps, children });
var BigFact = (_a) => {
  var _b = _a, {
    children,
    factInformation,
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsx20(FlexBox, { children: /* @__PURE__ */ jsxs12(Box, { children: [
    /* @__PURE__ */ jsx20(Text, __spreadProps(__spreadValues({ textAlign: "center", fontSize: factFontSize }, factProps), { children })),
    factInformation ? /* @__PURE__ */ jsx20(Text, __spreadProps(__spreadValues({ textAlign: "center" }, factInformationProps), { children: factInformation })) : null
  ] }) }) }));
};
var Quote2 = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsxs12(Box, { width: "100%", margin: "auto", children: [
    /* @__PURE__ */ jsx20(Text, __spreadProps(__spreadValues({ fontSize: "85px" }, quoteProps), { children })),
...
var CodeLayout = (_a) => {
  ...
  return /* @__PURE__ */ jsxs12(Box, { "data-testid": "CodePane", children: [
    text3 ? /* @__PURE__ */ jsx20(Text, __spreadProps(__spreadValues({ margin: 8 }, textProps), { children: text3 })) : null,
    /* @__PURE__ */ jsx20(code_pane_default, __spreadProps(__spreadValues({}, props), { children }))
  ] });
};
var Code = (_a) => {
  var _b = _a, {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsxs12(Box, { display: "inline-block", style: { overflow: "scroll" }, children: [
    title ? /* @__PURE__ */ jsx20(Heading, __spreadProps(__spreadValues({}, titleProps), { children: title })) : null,
    /* @__PURE__ */ jsx20(CodeLayout, __spreadProps(__spreadValues({ language }, codePaneProps), { children }))
  ] }) }));
};
...
var Image2 = ({
  ...
  imgProps,
  objectFit
}) => /* @__PURE__ */ jsx20(ImgContainer, __spreadProps(__spreadValues({ "data-testid": "ImgContainer" }, imgContainerProps), { children: /* @__PURE__ */ jsx20(
  Img,
  __spreadValues({
    "data-testid": "Img",
    src,
...
var HorizontalImage = (_a) => {
  ...
  return /* @__PURE__ */ jsxs12(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    ...
    title ? /* @__PURE__ */ jsx20(Heading, __spreadProps(__spreadValues({ textAlign: "left", margin: "0 0" }, titleProps), { children: title })) : null,
    description ? /* @__PURE__ */ jsx20(Text, __spreadProps(__spreadValues({ margin: "0 0" }, descriptionProps), { children: description })) : null
  ] }));
};
  ...
  return /* @__PURE__ */ jsxs12(slide_default, __spreadProps(__spreadValues({}, rest), { children: [
    ...
    /* @__PURE__ */ jsxs12(
      Grid,
      {
        ...
        height: "100%",
        children: [
          /* @__PURE__ */ jsx20(FlexBox, { justifyContent: "start", children: /* @__PURE__ */ jsx20(
            Ul,
            __spreadValues({
              items: listItems,
              animate: animateListItems,
...
var ThreeUpImage = (_a) => {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsxs12(
    Grid,
    {
      height: "100%",
      gridColumnGap: 2,
...
var FullBleedImage = (_a) => {
  ...
  return /* @__PURE__ */ jsx20(slide_default, __spreadProps(__spreadValues({ padding: "0 0 0" }, rest), { children: /* @__PURE__ */ jsx20(
    Image2,
    {
      src,
      alt,
...
var DefaultTemplate = ({ color: color5 = "#fff" }) => /* @__PURE__ */ jsxs13(
  FlexBox,
  {
    ...
    width: 1,
    children: [
      /* @__PURE__ */ jsx21(Box, { padding: "0 1em", children: /* @__PURE__ */ jsx21(fullscreen_default, { color: color5 }) }),
      /* @__PURE__ */ jsx21(Box, { padding: "1em", children: /* @__PURE__ */ jsx21(animated_progress_default, { color: color5 }) })
    ]
  }
);
...
var mdxComponentMap = {
  p: Text,
  h1: (props) => /* @__PURE__ */ jsx22(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h1" })),
  h2: (props) => /* @__PURE__ */ jsx22(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h2" })),
  h3: (props) => /* @__PURE__ */ jsx22(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h3" })),
  h4: (props) => /* @__PURE__ */ jsx22(Heading, __spreadProps(__spreadValues({}, props), { fontSize: "h4" })),
  blockquote: Quote,
  ul: UnorderedList,
  ol: OrderedList,
  li: ListItem,
...
var Columns = ({ children }) => /* @__PURE__ */ jsx23(FlexBox, { flexDirection: "row", alignItems: "start", flex: 1, children });
var Center2 = ({ children }) => /* @__PURE__ */ jsx23(FlexBox, { justifyContent: "center", alignItems: "center", height: "100%", children });
...
var MarkdownSlide = (_a) => {
  ...
  return /* @__PURE__ */ jsx24(slide_default, __spreadProps(__spreadValues({}, rest), { children: /* @__PURE__ */ jsx24(
    Markdown,
    __spreadValues({}, {
      componentMap,
      template,
...
var Markdown = forwardRef6(
  (_a, ref) => {
          ...
          const children2 = key === "p" ? (_a3 = props2.children) == null ? void 0 : _a3.map((child) => {
            if (typeof child == "string") {
              ...
              return lines.map((str, i) => /* @__PURE__ */ jsxs14(React.Fragment, { children: [
                str,
                i !== lines.length - 1 && /* @__PURE__ */ jsx25("br", {})
              ] }, i));
            }
            return child;
          }) : props2.children;
          return /* @__PURE__ */ jsx25(Component, __spreadProps(__spreadValues(__spreadValues({}, props2), componentProps || {}), { children: children2 }));
        };
        return newMap;
      }, {});
    ...
    return /* @__PURE__ */ jsx25(Container3, __spreadProps(__spreadValues({ ref }, props), { children: /* @__PURE__ */ jsxs14(TemplateComponent, __spreadProps(__spreadValues({}, restProps), { children: [
      (slideConfig == null ? void 0 : slideConfig.layout) === "columns" ? children.props.children : children,
      noteElements
    ] })) }));
  }
);
var AppearingListItem = (props) => /* @__PURE__ */ jsx25(Appear, { children: /* @__PURE__ */ jsx25(ListItem, __spreadValues({}, props)) });
var MarkdownSlideSet = (_a) => {
  ...
  return /* @__PURE__ */ jsx25(Fragment7, { children: mdSlides.map((md, ix) => {
    const props = {};
    ...
    return /* @__PURE__ */ jsx25(MarkdownSlide, __spreadProps(__spreadValues({ slideConfig: jsonObject }, props), { children: content }), ix);
  }) });
};
var MarkdownPreHelper = (PreComponent = "pre", CodeInlineComponent = "code", CodeBlockComponent) => (_a) => {
  ...
  const pre = /* @__PURE__ */ jsx25(PreComponent, __spreadProps(__spreadValues({}, restProps), { children }));
  ...
  return /* @__PURE__ */ jsx25(CodeBlockComponent, __spreadProps(__spreadValues(__spreadValues({}, restProps), restChildProps), { children: rawCode }));
};
var MarkdownCodePane = (_a) => {
  ...
  return /* @__PURE__ */ jsx25(code_pane_default, __spreadProps(__spreadValues({}, rest), { language, children }));
};
...
function SpectacleLogo({ size = 100 }) {
  return /* @__PURE__ */ jsx26(
    "svg",
    {
      ...
      clipRule: "evenodd",
      viewBox: "0 0 510 500",
      children: /* @__PURE__ */ jsx26("g", { transform: "translate(.56 -8.403)", children: /* @__PURE__ */ jsx26("g", { children: /* @__PURE__ */ jsx26("g", { children: /* @__PURE__ */ jsxs15("g", { children: [
        /* @__PURE__ */ jsx26(
          "path",
          {
            fill: "#202020",
        ...
        /* @__PURE__ */ jsx26("g", { transform: "translate(109.244 121.849)", children: /* @__PURE__ */ jsxs15("g", { fillRule: "nonzero", children: [
          /* @__PURE__ */ jsx26(
            "path",
            {
              fill: "#F14E74",
        ...
        /* @__PURE__ */ jsx26("g", { transform: "translate(111.013 374.877)", children: /* @__PURE__ */ jsxs15("g", { children: [
          /* @__PURE__ */ jsx26(
            "path",
            {
              fill: "#FC6986",
