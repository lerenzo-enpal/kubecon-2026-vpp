...
25. **Summer Arbitrage** -- Full-screen Berlin map HUD, 6-step summer scenario [VPPScenarioMapSlide]
26. **Winter Grid Emergency** -- Full-screen Berlin map HUD, 5-step winter scenario [VPPScenarioMapSlide]

### The Architecture
27. **The Architecture** -- Sub-section title
28. **How It Works** -- Animated VPP architecture flow [VPPArchitecture]
29. **Inside the Architecture** -- Cyclic data flow diagram [EnpalArchitectureDiagram]
...
32. **SA Blackout, 2016** -- Full-screen South Australia blackout map [SAMapHUD]
33. **SA Virtual Power Plant, 2019** -- 1,100 homes, Hornsdale proof [SAMapHUD]

### Closing
34. **Back to Texas** -- Revisit 4:37, 10 GW distributed batteries
35. **Thank You** -- Closing slide, Enpal branding

### Appendix
36. **The Dunkelflaute** -- Dark doldrums: wind+solar collapse, Germany Nov 2024
37. **Demand Response in Action** -- Interactive demo [DemandResponseDemo] [WIP]
