# South Australia Blackout -- 28 September 2016
...
| **Duration** | Bulk restoration within ~8 hours; full restoration 11 October 2016 (13 days) |
| **Affected population** | ~1.7 million people (entire state of South Australia) |
| **Affected connections** | ~850,000 customer connections |
| **Cause** | Severe storm / tornado damage to transmission lines + wind farm LVRT protection cascade |
| **Generation lost** | 456 MW from nine wind farms in <7 seconds |
| **Interconnector** | Heywood interconnector overloaded at ~850 MW (capacity ~650 MW), tripped |
...
The Australian Energy Regulator (AER) took legal action against four wind farm operators:
...
The Australian Energy Market Commission (AEMC) published a comprehensive review: *"Mechanisms to Enhance Resilience in the Power System"* -- recommending structural changes to prevent cascading failures in high-renewable grids.

---

## 7. The Aftermath: Birth of Australia's Battery/VPP Revolution
...
## 8. Relevance to VPP / Why This Event Matters

The September 2016 South Australia blackout is **the origin event** for Australia's battery and Virtual Power Plant revolution. Its significance:
