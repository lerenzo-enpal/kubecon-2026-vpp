  ...
  return (
    <>
      ...
      <Deck theme={spectacleTheme} template={template}>
        ...
        <Slide backgroundColor={bg} padding="0">
          <StepBridge count={4}>{step => <div data-testid="grid-pressure-scene" className="relative h-full"><JapanGridAtlas step={step} preset={keynoteAtlasPreset} /><div className="pointer-events-none absolute inset-0" data-testid="grid-pressure-atlas"><div className="absolute left-8 top-8 max-w-lg"><div className="font-[var(--font-mono)] text-xs tracking-[0.16em] text-[var(--color-primary)]">ACT II / WINTER DEMAND</div><h1 className="my-2 font-[var(--font-heading)] text-4xl font-extrabold text-[var(--color-heading)]">Grid pressure</h1><p className="m-0 text-lg text-[var(--color-text)]">January 2021: a cold snap made demand peak together.</p></div>{step >= 1 && <aside data-testid="act2-jepx-sidecar" className="absolute right-8 top-8 w-72 border border-[var(--color-danger)]/80 bg-[color-mix(in_srgb,var(--color-bg)_90%,transparent)] p-5"><div className="font-[var(--font-mono)] text-xs tracking-[0.14em] text-[var(--color-danger)]">JAN–FEB 2021 · JEPX</div><div className="mt-2 font-[var(--font-heading)] text-3xl font-bold text-[var(--color-heading)]">25× spike</div><div className="mt-1 text-base text-[var(--color-text)]">10 → 251 yen/kWh for 40 days</div></aside>}{step >= 2 && <div data-testid="act2-demand-card" className="absolute bottom-8 left-8 w-80 border-l-4 border-[var(--color-danger)] bg-[color-mix(in_srgb,var(--color-bg)_90%,transparent)] p-5 text-base text-[var(--color-text)]"><div className="font-[var(--font-mono)] text-xs tracking-[0.14em] text-[var(--color-danger)]">DEMAND CASCADE ACTIVE</div><div className="mt-2">Regional constraints spread the pressure across the system.</div></div>}{step >= 2 && <div data-testid="act2-cold-snap-route" className="sr-only">Cold-snap grid flow</div>}</div></div>}</StepBridge>
